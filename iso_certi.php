            ...
            <div class="row justify-content-center">
                <div class="col-md-10 col-lg-9">
                    <div class="section-heading text-center text-white mb-5">
                        <h2 class="text-white">ISO Certified</h2>
                        <p class="lead">The Best Health Care Website Creation And<br> 
Digital Marketing Firm In Pune for Healthcare Providers.</p>
         <div class="custom-breadcrumb">
                            <ol class="breadcrumb d-inline-block bg-transparent list-inline py-0">
                                ...
                                <li class="list-inline-item breadcrumb-item active"> <a href="iso_certi.php">ISO Certified</a> </li>
                            </ol>
...
<br>
   <center> <img src="dg_img/certificate.png" style="border:1px solid black;" class="img-right"></center> <br>
         <!--promo section end-->
